        ...
        <div className="px-6 py-5 flex justify-between items-center bg-gradient-to-r from-gray-50 to-white">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm text-gray-600">
              {t('job')} {currentBatch.job_id?.substring(0, 8)} - {t('modern_enrichment_cascade')}
            </p>
          </div>
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-3">
              <span className="text-sm font-medium text-gray-700">
                {t('processing')} {currentBatch.completed} {t('of')} {currentBatch.total} {t('contacts')}
              </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-4 rounded-xl border border-orange-200">
              ...
              <div className="text-xl font-bold text-orange-900 mt-1">
                {Math.round(currentBatch.credits_used || 0)} {t('credits')}
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3">
              ...
              <div className="bg-white p-3 rounded-lg border border-gray-200 relative">
                ...
                <div className="text-xs text-gray-600 space-y-1">
                  ...
                  <div>{t('contacts')}: {currentBatch.total}</div>
                </div>
              </div>
