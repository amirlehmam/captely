...
const ImportPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (modalIsOpen) {
      ...
      // Note: Clearing all timeouts is not reliable in browser environment
      // Individual timeout/interval management should be handled by components
    } else {
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <Link
                        ...
                        className={`text-primary-600 hover:text-primary-500 ${
                          isDark ? 'text-primary-400 hover:text-primary-300' : ''
                        }`}
                      >
